...
// actor locator). The actor family (create / modify / tree / components) lands
// in later P2 tasks and appends its tools here.
export const ALL_TOOLS: Tool[] = [ping, actorFind];
